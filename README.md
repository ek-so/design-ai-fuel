...
1. **Skills** — each folder under `.agents/skills/` is one skill. Invoke with `/skill-name`, or describe a matching task and let the agent pick it up from the skill description.

2. **AGENTS.md** — directional rules for how agents should behave.

3. **Utils** — `.agents/_utils/` holds setup guides for external tools:
